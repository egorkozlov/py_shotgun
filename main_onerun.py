...
if __name__ == '__main__':
    ...
    x = {'sigma_psi': 0.16356029392141358,
         'sigma_psi_mult': 5.445381382841502,
         'pmeet_0': 0.37806608370632,
         'pmeet_t': 0.0059032495766286885,
         'pmeet_t2': -0.0005223511572444439,
         'preg_a0': 0.04483573710429613,
         'preg_at': 0.005466915801374345,
         'preg_at2': -1.2787095301364237e-07,
         'u_shift_mar': 1.6672233943109374,
         'util_alp': 0.6445054596402359,
         'util_kap': 0.798762705474946,
         'util_qbar': 0.05338609987032369,
         'disutil_marry_sm_mal_coef': 5.0334932446425675,
         'disutil_shotgun_coef': 1.6497516684216278}
