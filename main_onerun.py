...
if __name__ == '__main__':
    ...
    '''
    # low educ:
    x = {'sigma_psi': 0.3944043105613717,
         'sigma_psi_mult': 6.233264275393538,
         'pmeet_21': 0.38704153331368285,
         'pmeet_28': 0.13666441398389095,
         'pmeet_35': 0.4334561206695717,
         'preg_21': 0.1780260336816717,
         'preg_28': 0.2261031982738304,
         'preg_35': -0.049602070083370656,
         'util_kap': 0.853510257222418,
         'util_qbar': 0.0,
         'disutil_marry_sm_mal_coef': 7.987687567814818,
         'disutil_shotgun_coef': 0.0,
         'taste_shock_mult': 9.956537271784269,
         'u_shift_mar': 1.7329041070973545,
         'util_alp': 0.6182672481649074}
    '''
    x = {'sigma_psi': 0.29935419184391954,
         'sigma_psi_mult': 6.803701408202784,
         'pmeet_21': 0.37625868669450613,
         'pmeet_28': 0.132659740055266,
         'pmeet_35': 0.5318032038237019,
         'preg_21': 0.23348399939211098,
         'preg_28': 0.14970582608808505,
         'preg_35': -0.006300630120694192,
         'u_shift_mar': 1.6589205191372485,
         'util_alp': 0.4201287572847545,
         'util_kap': 0.8548606358545989,
         'util_qbar': 0.39077179939422335,
         'disutil_marry_sm_mal_coef': 6.0507093623984245,
         'disutil_shotgun_coef': 0.0891624545474013,
         'taste_shock_mult': 1.4166492669240947}
